...
class exploitationTimeBehaviors:
    ...
    def behavior_vector(self, n = 5):
        ...
        timing_micro_behaviors = {'time_delta': exploitationTimeBehaviors.time_delta(self), + 'time_interval': exploitationTimeBehaviors.get_time_interval(self),
        ...
        uri_micro_behaviors = {'isBase64': microBehaviors.isBase64(self),
